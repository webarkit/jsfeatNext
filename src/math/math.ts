...
export class math extends jsfeatNext {
    ...
    // NB: motion_estimator.lmeds calls this with a Float32Array cache buffer,
    // so the signature accepts typed arrays as well as plain number[] (the old
    // stub hid this behind `any`).
