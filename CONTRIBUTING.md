# Contributing to jsfeatNext

Thank you for your interest in contributing to `jsfeatNext`! By following these guidelines, you help keep the project clean, organized, and easy to maintain.
...
If you add a new feature, make sure to include appropriate tests in `tests/**/tests.rs` or as integration tests.
...
### 3. Examples
* `feat(imgproc): implement implement gaussian blur method`
* `perf(core): optimize memory allocation for data allocation`
...
Before creating a new issue, please search the [existing issues](https://github.com/webarkit/jsfeatNext/issues) to see if it has already been reported.
...
If you encounter a bug or have an idea for a new feature, we invite you to open an [Issue](https://github.com/webarkit/jsfeatNext/issues). Please be as detailed as possible in the description to help us resolve the issue quickly.
