...
var e = new class {
	...
	scripts: {
		...
		"bench:smoke": "vitest bench --run --testNamePattern=\"__collect_only__\"",
		test: "vitest run",
		"test:coverage": "vitest run --coverage",
		bench: "vitest bench",
		"bench:ratios": "vitest bench --run --outputJson bench-results/raw.json && node scripts/bench-ratios.mjs bench-results/raw.json --append bench/history.jsonl",
		"test:watch": "vitest",
		docs: "typedoc"
	},
	repository: {
...
o = c, o.VERSION = a.version, o.EPSILON = i.EPSILON, o.FLT_MIN = i.FLT_MIN, o.U8_t = i.U8_t, o.S32_t = i.S32_t, o.F32_t = i.F32_t, o.S64_t = i.S64_t, o.F64_t = i.F64_t, o.C1_t = i.C1_t, o.C2_t = i.C2_t, o.C3_t = i.C3_t, o.C4_t = i.C4_t, o.COLOR_RGBA2GRAY = i.COLOR_RGBA2GRAY, o.COLOR_RGB2GRAY = i.COLOR_RGB2GRAY, o.COLOR_BGRA2GRAY = i.COLOR_BGRA2GRAY, o.COLOR_BGR2GRAY = i.COLOR_BGR2GRAY, o.BOX_BLUR_NOSCALE = i.BOX_BLUR_NOSCALE, o.SVD_U_T = i.SVD_U_T, o.SVD_V_T = i.SVD_V_T, o.NORM_HAMMING = i.NORM_HAMMING, o.U8C1_t = o.U8_t | o.C1_t, o.U8C3_t = o.U8_t | o.C3_t, o.U8C4_t = o.U8_t | o.C4_t, o.F32C1_t = o.F32_t | o.C1_t, o.F32C2_t = o.F32_t | o.C2_t, o.S32C1_t = o.S32_t | o.C1_t, o.S32C2_t = o.S32_t | o.C2_t;
//#endregion
//#region src/matrix_t/matrix_t.ts
var l = class n {
	constructor(t, r, a, o) {
		this.dt = e, this.type = this.dt._get_data_type(a) | 0, this.channel = this.dt._get_channel(a) | 0, this.cols = t | 0, this.rows = r | 0, o === void 0 ? this.allocate() : (this.buffer = o, n._reject_S64_t(this.type), this.data = this.type & i.U8_t ? this.buffer.u8 : this.type & i.S32_t ? this.buffer.i32 : this.type & i.F32_t ? this.buffer.f32 : this.buffer.f64);
	}
	static _reject_S64_t(e) {
		if (e & i.S64_t) throw Error("matrix_t: S64_t is declared but not implemented (issue #139) — no view-selection path returns a genuine 64-bit integer view. Supported types: U8_t, S32_t, F32_t, F64_t.");
	}
	allocate() {
		n._reject_S64_t(this.type), delete this.data, delete this.buffer, this.buffer = new t(this.cols * this.dt._get_data_type_size(this.type) * this.channel * this.rows), this.data = this.type & i.U8_t ? this.buffer.u8 : this.type & i.S32_t ? this.buffer.i32 : this.type & i.F32_t ? this.buffer.f32 : this.buffer.f64;
	}
	copy_to(e) {
...
var m = class extends c {
	...
	get_gaussian_kernel(e, t, n, r) {
		let a = 0, o = 0, s = 0, c = 0, l = 0, u = 0, d = this.cache.get_buffer(e << 2), f = d.f32;
		...
		else for (u = 1 / u, a = 0; a < e; ++a) n[a] = f[a] * u;
	...
	perspective_4point_transform(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g) {
		...
		_ = r, v = d, y = c, b = _ * v * y, x = g, S = _ * x, C = v * S, w = f, T = _ * w, E = s, D = i, O = h, k = D * O, A = k * E, j = O * E * w, M = O * y, N = O * w, P = v * y, F = x * v, I = x * E, L = w * E, R = 1 / (M - N - P + F - I + L), z = _ * O, B = D * E, V = y * _, ee = x * V, H = D * v, U = k * w, W = D * w * E, G = y * x * v, te = x * D;
		let re = -(C - b + T * E - E * S - k * v + A - j + M * v) * R, ie = (b - C - z * y + z * w + A - v * B + I * v - j) * R, ae = _, oe = (-w * S + ee + H * y - k * y + U - W + I * w - G) * R, se = (-ee + V * w - te * v + U - W + te * E + G - M * w) * R, ce = D, le = (-T + V + H - B + N - M - F + I) * R, ue = (-S + T + k - H + I - L - M + P) * R;
		v = Y - Q * X, y = ne * Y, b = ne * X, S = J * K, C = q * J, T = K * Z;
		let de = q * Z;
	...
	grayscale(e, t, n, r, a) {
		a === void 0 && (a = i.COLOR_RGBA2GRAY);
		let o = 0, s = 0, c = 0, l = 0, u = 0, d = 0, f = 4899, p = 9617, m = 1868, h = 4;
		(a == i.COLOR_BGRA2GRAY || a == i.COLOR_BGR2GRAY) && (f = 1868, m = 4899), (a == i.COLOR_RGB2GRAY || a == i.COLOR_BGR2GRAY) && (h = 3);
		let g = h << 1, _ = h * 3 | 0;
		r.resize(t, n, 1);
		let v = r.data;
		for (s = 0; s < n; ++s, l += t, c += t * h) {
			for (o = 0, u = c, d = l; o <= t - 4; o += 4, u += h << 2, d += 4) v[d] = e[u] * f + e[u + 1] * p + e[u + 2] * m + 8192 >> 14, v[d + 1] = e[u + h] * f + e[u + h + 1] * p + e[u + h + 2] * m + 8192 >> 14, v[d + 2] = e[u + g] * f + e[u + g + 1] * p + e[u + g + 2] * m + 8192 >> 14, v[d + 3] = e[u + _] * f + e[u + _ + 1] * p + e[u + _ + 2] * m + 8192 >> 14;
			for (; o < t; ++o, ++d, u += h) v[d] = e[u] * f + e[u + 1] * p + e[u + 2] * m + 8192 >> 14;
		}
	}
	resample(e, t, n, r) {
	...
	scharr_derivatives(e, t) {
		let n = e.cols, r = e.rows, a = n << 1, o = 0, s = 0, c = 0, l, u, d, f, p, m, h = 0, g = 0, _ = 0, v = 0, y, b;
		t.resize(n, r, 2);
		let x = e.data, S = t.data, C = this.cache.get_buffer(n + 2 << 2), w = this.cache.get_buffer(n + 2 << 2);
		for (e.type & i.U8_t || e.type & i.S32_t ? (y = C.i32, b = w.i32) : (y = C.f32, b = w.f32); s < r; ++s, g += n) {
			for (h = (s > 0 ? s - 1 : 1) * n | 0, _ = (s < r - 1 ? s + 1 : r - 2) * n | 0, v = s * a | 0, o = 0, c = 1; o <= n - 2; o += 2, c += 2) l = x[h + o], u = x[_ + o], y[c] = (l + u) * 3 + x[g + o] * 10, b[c] = u - l, l = x[h + o + 1], u = x[_ + o + 1], y[c + 1] = (l + u) * 3 + x[g + o + 1] * 10, b[c + 1] = u - l;
			for (; o < n; ++o, ++c) l = x[h + o], u = x[_ + o], y[c] = (l + u) * 3 + x[g + o] * 10, b[c] = u - l;
			for (o = n + 1 | 0, y[0] = y[1], y[o] = y[n], b[0] = b[1], b[o] = b[n], o = 0; o <= n - 4; o += 4) l = b[o + 2], u = b[o + 1], d = b[o + 3], f = b[o + 4], p = y[o + 2], m = y[o + 3], S[v++] = p - y[o], S[v++] = (l + b[o]) * 3 + u * 10, S[v++] = m - y[o + 1], S[v++] = (d + u) * 3 + l * 10, S[v++] = y[o + 4] - p, S[v++] = (f + l) * 3 + d * 10, S[v++] = y[o + 5] - m, S[v++] = (b[o + 5] + d) * 3 + f * 10;
			for (; o < n; ++o) S[v++] = y[o + 2] - y[o], S[v++] = (b[o + 2] + b[o]) * 3 + b[o + 1] * 10;
		}
	...
	sobel_derivatives(e, t) {
		...
		let x = e.data, S = t.data, C = this.cache.get_buffer(n + 2 << 2), w = this.cache.get_buffer(n + 2 << 2);
		for (e.type & i.U8_t || e.type & i.S32_t ? (y = C.i32, b = w.i32) : (y = C.f32, b = w.f32); s < r; ++s, g += n) {
			for (h = (s > 0 ? s - 1 : 1) * n | 0, _ = (s < r - 1 ? s + 1 : r - 2) * n | 0, v = s * a | 0, o = 0, c = 1; o <= n - 2; o += 2, c += 2) l = x[h + o], u = x[_ + o], y[c] = l + u + x[g + o] * 2, b[c] = u - l, l = x[h + o + 1], u = x[_ + o + 1], y[c + 1] = l + u + x[g + o + 1] * 2, b[c + 1] = u - l;
			for (; o < n; ++o, ++c) l = x[h + o], u = x[_ + o], y[c] = l + u + x[g + o] * 2, b[c] = u - l;
			for (o = n + 1 | 0, y[0] = y[1], y[o] = y[n], b[0] = b[1], b[o] = b[n], o = 0; o <= n - 4; o += 4) l = b[o + 2], u = b[o + 1], d = b[o + 3], f = b[o + 4], p = y[o + 2], m = y[o + 3], S[v++] = p - y[o], S[v++] = l + b[o] + u * 2, S[v++] = m - y[o + 1], S[v++] = d + u + l * 2, S[v++] = y[o + 4] - p, S[v++] = f + l + d * 2, S[v++] = y[o + 5] - m, S[v++] = b[o + 5] + d + f * 2;
			for (; o < n; ++o) S[v++] = y[o + 2] - y[o], S[v++] = b[o + 2] + b[o] + b[o + 1] * 2;
		}
		this.cache.put_buffer(C), this.cache.put_buffer(w);
	}
	...
	canny(e, t, n, r) {
		...
		for (c = 1; c <= o; ++c, d += f) {
			...
			for (p = d - f | 0, E[P - 1] = 0, m = 0, u = 0; u < a; ++u, p += 2) {
				if (h = T[j + u], h > n) {
					if (g = O[p], _ = O[p + 1], v = g ^ _, g = (g ^ g >> 31) - (g >> 31) | 0, _ = (_ ^ _ >> 31) - (_ >> 31) | 0, y = g * 13573, b = y + (g + g << 15), _ <<= 15, _ < y) {
						if (h > T[j + u - 1] && h >= T[j + u + 1]) {
							h > r && !m && E[P + u - N] != 2 ? (E[P + u] = 2, m = 1, D[F++] = P + u) : E[P + u] = 1;
							continue;
						}
					} else if (_ > b) {
						if (h > T[A + u] && h >= T[M + u]) {
					...
					} else if (v = v < 0 ? -1 : 1, h > T[A + u - v] && h > T[M + u + v]) {
						h > r && !m && E[P + u - N] != 2 ? (E[P + u] = 2, m = 1, D[F++] = P + u) : E[P + u] = 1;
						continue;
					}
				}
...
var v = i.EPSILON, y = class {
	...
	invert_3x3(e, t) {
		let n = e.data, r = t.data, i = n[4], a = n[8], o = n[5], s = n[7], c = n[0], l = c * i, u = c * o, d = n[3], f = n[1], p = d * f, m = n[2], h = d * m, g = n[6], _ = g * f, y = g * m, b = l * a - u * s - p * a + h * s + _ * o - y * i, x = 1 / b;
		return r[0] = (i * a - o * s) * x, r[1] = -(f * a - m * s) * x, r[2] = -(-f * o + m * i) * x, r[3] = -(d * a - o * g) * x, r[4] = (c * a - y) * x, r[5] = -(u - h) * x, r[6] = -(-d * s + i * g) * x, r[7] = -(c * s - _) * x, r[8] = (l - p) * x, b < v && b > -v ? 0 : 1;
	}
	multiply_3x3(e, t, n) {
	...
	JacobiImpl(e, t, n, r, a, o) {
		...
		for (u = 0; u < o; u++) {
			if (n[u] = e[(t + 1) * u], u < o - 1) {
				for (d = u + 1, b = Math.abs(e[t * u + d]), c = u + 2; c < o; c++) x = Math.abs(e[t * u + c]), b < x && (b = x, d = c);
				j[u] = d;
			}
			if (u > 0) {
				for (d = 0, b = Math.abs(e[u]), c = 1; c < u; c++) x = Math.abs(e[t * c + u]), b < x && (b = x, d = c);
				M[u] = d;
			}
		}
		if (o > 1) for (; v < y; v++) {
			...
			for (l = 0; l < 2; l++) {
				...
				if (p > 0) {
					for (d = 0, b = Math.abs(e[p]), c = 1; c < p; c++) x = Math.abs(e[t * c + p]), b < x && (b = x, d = c);
					M[p] = d;
				}
			}
		}
	...
	JacobiSVDImpl(e, t, n, r, a, o, s, c) {
		...
		for (d = 0; d < c; d++) {
			for (O = d < s ? B[d] : 0; O <= u;) {
				for (L = 1 / o, p = 0; p < o; p++) F = F * 214013 + 2531011, I = F >> 16 & 256 ? L : -L, e[d * t + p] = I;
				for (m = 0; m < 2; m++) for (f = 0; f < d; f++) {
					for (O = 0, p = 0; p < o; p++) O += e[d * t + p] * e[f * t + p];
					for (R = 0, p = 0; p < o; p++) T = e[d * t + p] - O * e[f * t + p], e[d * t + p] = T, R += Math.abs(T);
					for (R = R ? 1 / R : 0, p = 0; p < o; p++) e[d * t + p] *= R;
				}
				for (O = 0, p = 0; p < o; p++) T = e[d * t + p], O += T * T;
				O = Math.sqrt(O);
			}
			for (w = 1 / O, p = 0; p < o; p++) e[d * t + p] *= w;
		}
		this.cache.put_buffer(z);
	}
	lu_solve(e, t) {
	...
	lm_solve(e, t, n, r = 10, a = 1e-10) {
		...
		g.f64;
		let w = _.f64, T = new l(o, o, i.F64_t | i.C1_t, m.data), E = new l(1, o, i.F64_t | i.C1_t, g.data), D = .001, O = !0, k = (e) => {
			let t = 0;
			for (let n = 0; n < s; ++n) t += e[n] * e[n];
			return t;
		};
		if (!n.compute(c, v, b)) O = !1;
		else {
			let e = k(v);
			for (let t = 0; t < r; ++t) {
				for (let e = 0; e < o; ++e) {
					let t = 0;
					for (let n = 0; n < s; ++n) t += b[n * o + e] * v[n];
					C[e] = t;
					for (let t = e; t < o; ++t) {
						let n = 0;
						for (let r = 0; r < s; ++r) n += b[r * o + e] * b[r * o + t];
						x[e * o + t] = x[t * o + e] = n;
					}
				}
				let t = !1;
				for (let r = 0; r < 10; ++r) {
					S.set(x.subarray(0, o * o));
					for (let e = 0; e < o; ++e) S[e * o + e] += D;
					if (E.data.set(C.subarray(0, o)), !this.cholesky_solve(T, E)) {
						D *= 10;
						continue;
					}
					for (let e = 0; e < o; ++e) w[e] = c[e] - E.data[e];
					if (!n.compute(w, y, null)) {
						O = !1;
						break;
					}
					let r = k(y);
					if (r < e) {
						for (let e = 0; e < o; ++e) c[e] = w[e];
						D = Math.max(D / 10, 1e-12), t = Math.abs(e - r) > a * e, e = r;
						break;
					}
					D *= 10;
				}
		...
		return this.cache.put_buffer(u), this.cache.put_buffer(d), this.cache.put_buffer(g), this.cache.put_buffer(f), this.cache.put_buffer(p), this.cache.put_buffer(m), this.cache.put_buffer(h), this.cache.put_buffer(_), O;
	}
	svd_decompose(e, t, n, r, a) {
		...
		if (this.JacobiSVDImpl(_.data, d, v.data, y.data, f, d, f, d), t) {
			for (s = 0; s < f; s++) t.data[s] = v.data[s];
			for (; s < u; s++) t.data[s] = 0;
		}
		if (o == 0) {
			if (n && a & i.SVD_U_T) for (s = d * d; --s >= 0;) n.data[s] = _.data[s];
			else n && this.matmath.transpose(n, _);
			if (r && a & i.SVD_V_T) for (s = f * f; --s >= 0;) r.data[s] = y.data[s];
			else r && this.matmath.transpose(r, y);
		} else {
			if (n && a & i.SVD_U_T) for (s = f * f; --s >= 0;) n.data[s] = y.data[s];
			else n && this.matmath.transpose(n, y);
			if (r && a & i.SVD_V_T) for (s = d * d; --s >= 0;) r.data[s] = _.data[s];
...
var S = class extends c {
	...
	detect(e, t, n) {
		n === void 0 && (n = 3);
		let r = e.data, i = e.cols, a = e.rows, o = 0, s = 0, c = 0, l = 0, u = 0, d = 0, f = this.cache.get_buffer(3 * i), p = this.cache.get_buffer((i + 1) * 3 << 2), m = f.u8, h = p.i32, g = this.pixel_off, _ = this.score_diff, v = Math.max(3, n), y = Math.min(a - 2, a - n), b = Math.max(3, n), S = Math.min(i - 3, i - n), C = 0, w = 0, T, E = x, D = this.threshold_tab, O = this._threshold, k = 0, A = 0, j = 0, M = 0, N = 0, P = 0, F = 0, I = 0, L = 0, R = 0, z = 0, B = 0;
		this._cmp_offsets(g, i, 16);
		let V = g[0], ee = g[1], H = g[2], U = g[3], W = g[4], G = g[5], te = g[6], ne = g[7], K = g[8], q = g[9], J = g[10], Y = g[11], X = g[12], Z = g[13], Q = g[14], re = g[15];
		for (o = 0; o < i * 3; ++o) m[o] = 0;
		for (o = v; o < y; ++o) {
			for (F = o * i + b | 0, d = (o - 3) % 3, P = d * i | 0, N = d * (i + 1) | 0, s = 0; s < i; ++s) m[P + s] = 0;
			if (M = 0, o < y - 1) {
			...
			if (h[N + i] = M, o != v) for (d = (o - 4 + 3) % 3, I = d * i | 0, N = d * (i + 1) | 0, d = (o - 5 + 3) % 3, L = d * i | 0, M = h[N + i], c = 0; c < M; ++c) s = h[N + c], R = s + 1 | 0, z = s - 1 | 0, B = m[I + s], B > m[I + R] && B > m[I + z] && B > m[L + z] && B > m[L + s] && B > m[L + R] && B > m[P + z] && B > m[P + s] && B > m[P + R] && (T = t[w], T.x = s, T.y = o - 1, T.score = B, w++);
		}
		return this.cache.put_buffer(f), this.cache.put_buffer(p), w;
	}
	_cmp_offsets(e, t, n) {
...
var O = new Int32Array([
	...
	constructor() {
		super(), this.bit_pattern_31_ = new Int32Array(E), this.H = new l(3, 3, i.F32_t | i.C1_t), this.patch_img = new l(32, 32, i.U8_t | i.C1_t), this.imgproc = new h();
	}
	ic_angle(e, t, n) {
		let r = 0, i = 0, a = e.data, o = e.cols, s = 0, c = 0, l = n * o + t | 0, u = 0, d = 0, f = 0, p = 0;
		for (s = -15; s <= 15; ++s) i += s * a[l + s];
		for (c = 1; c <= 15; ++c) {
			for (u = 0, d = O[c], s = -d; s <= d; ++s) f = a[l + s + c * o], p = a[l + s - c * o], u += f - p, i += s * (f + p);
			r += c * u;
		}
	...
	describe(e, t, n, r) {
		...
		let h = r.data, g = 0;
		for (a = 0; a < n; ++a) {
			for (s = t[a].x, c = t[a].y, l = t[a].angle, D(e, this.patch_img, l, s, c, 32, this.H, this.imgproc), m = 0, o = 0; o < 32; ++o) u = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, d = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, f = u < d | 0, u = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, d = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, f |= (u < d) << 1, u = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, d = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, f |= (u < d) << 2, u = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, d = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, f |= (u < d) << 3, u = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, d = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, f |= (u < d) << 4, u = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, d = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, f |= (u < d) << 5, u = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, d = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, f |= (u < d) << 6, u = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, d = p[528 + this.bit_pattern_31_[m + 1] * 32 + this.bit_pattern_31_[m]], m += 2, f |= (u < d) << 7, h[g + o] = f;
			g += 32;
		}
	}
};
...
var P = class {
	constructor(e, t, n) {
		this.dirs = /* @__PURE__ */ new Int32Array(1024), this.dirs_count = A(e, this.dirs, n) | 0, this.scores = new Int32Array(e * t), this.radius = n | 0;
	}
}, F = j, I = M, L = N, R = class {
	constructor() {
	...
	init(e, t, n, r = 1) {
		...
		for (let i = 0; i < r; ++i) this.level_tables[i] = new P(e >> i, t >> i, n);
	}
	detect(e, t, n = 4) {
		...
		for (g = E * u + T | 0, h = E; h < O; ++h, g += u) for (m = T, _ = g; m < D; ++m, ++_) v = l[_] + S, y = l[_] - S, y < l[_ + i] && l[_ + i] < v && y < l[_ - i] && l[_ - i] < v ? p[_] = 0 : L(l, _, p, y, v, o, c, s);
		for (g = E * u + T | 0, h = E; h < O; ++h, g += u) for (m = T, _ = g; m < D; ++m, ++_) x = p[_], b = Math.abs(x), b < 5 ? (++m, ++_) : F(p, _, u) >= 3 && I(p, _, x, f, i) && (w = t[C], w.x = m, w.y = h, w.score = b, ++C, m += a, _ += a);
		return C;
	}
};
//#endregion
...
var V = z, ee = B, H = class extends c {
	constructor() {
	...
	detect(e, t, n) {
		...
		for (r = a * o; --r >= 0;) f[r] = 0;
		for (V(s, f, a, 5, c, x, S, C, w), m = S * a + x | 0, i = S; i < w; ++i, m += a) for (r = x, h = m; r < C; ++r, ++h) p = f[h], (p < -y && p < f[h - 1] && p < f[h + 1] && p < f[h - a] && p < f[h + a] && p < f[h - a - 1] && p < f[h + a - 1] && p < f[h - a + 1] && p < f[h + a + 1] || p > y && p > f[h - 1] && p > f[h + 1] && p > f[h - a] && p > f[h + a] && p > f[h - a - 1] && p > f[h + a - 1] && p > f[h - a + 1] && p > f[h + a + 1]) && (g = ee(s, h, p, 5, c, l, u), g > b && (_ = t[v], _.x = r, _.y = i, _.score = g, ++v, ++r, ++h));
		return this.cache.put_buffer(d), v;
	}
}, U = class {
	constructor(e = 0, t = .5, n = .5, r = .99, i = () => Math.random()) {
		this.size = e, this.thresh = t, this.eps = n, this.prob = r, this.rng = i;
	}
	update_iters(e, t) {
	...
	get_subset(e, t, n, r, i, a, o, s = Math.random) {
		let c = 1e3, l = [], u = 0, d = 0, f = 0, p = 0, m = !1;
		for (; f < c; ++f) {
			for (u = 0; u < r && f < c;) {
				for (m = !1, p = 0; !m && f < c;) {
					for (m = !0, p = l[u] = Math.floor(s() * i) | 0, d = 0; d < u; ++d) if (p == l[d]) {
						m = !1;
						break;
					}
					m || ++f;
				...
				if (!m) break;
				if (a[u] = t[p], o[u] = n[p], !e.check_subset(a, o, u + 1)) {
					f++;
					continue;
				}
				++u;
	...
	ransac(e, t, n, r, a, o, s, c) {
		...
		for (; f < d; ++f) {
			if (g = this.get_subset(t, n, r, u, a, m, h, e.rng), !g) {
				if (f == 0) return this.cache.put_buffer(b), this.cache.put_buffer(x), this.cache.put_buffer(S), !1;
				break;
			}
			D = t.run(m, h, C, u), !(D <= 0) && (E = this.find_inliers(t, C, n, r, a, e.thresh, O, w.data), E > Math.max(T, u - 1) && (C.copy_to(o), T = E, s && w.copy_to(s), d = e.update_iters((a - E) / a, d), p = !0));
		}
	...
	lmeds(e, t, n, r, a, o, s, c) {
		...
		if (e.eps = .45, d = e.update_iters(e.eps, d), a == u) {
			...
			return this.cache.put_buffer(S), this.cache.put_buffer(C), this.cache.put_buffer(w), !0;
		}
		for (; f < d; ++f) {
			if (v = this.get_subset(t, n, r, u, a, g, _, e.rng), !v) {
	...
	find_homography(e, t, n, r, a, o, s, c = "ransac", u = 1e3, d = 0) {
		let f = e.size, p = o.cols, h = o.rows, g = o.type | i.C1_t, _ = this.cache.get_buffer(a), v = new l(a, 1, i.U8C1_t, _.data);
		if (!(c === "lmeds" ? this.lmeds(e, t, n, r, a, o, v, u) : this.ransac(e, t, n, r, a, o, v, u))) return this.cache.put_buffer(_), !1;
		let y = [], b = [];
		for (let e = 0; e < a; ++e) v.data[e] && (y.push(n[e]), b.push(r[e]));
		if (y.length > f) {
			let s = this.cache.get_buffer(p * h << 3), u = new l(p, h, g, s.data);
			if (t.run(y, b, u, y.length) > 0) {
				let s = this.cache.get_buffer(a << 2), d = this.cache.get_buffer(a), p = s.f32, h = new l(a, 1, i.U8C1_t, d.data), g = e.thresh;
				if (c === "lmeds") {
					t.error(n, r, u, p, a);
					let e = new m().median(p, 0, a - 1);
					g = Math.max(2.5 * 1.4826 * (1 + 5 / (a - f)) * Math.sqrt(e), .001);
				}
				this.find_inliers(t, u, n, r, a, g, p, h.data) >= f && (u.copy_to(o), h.copy_to(v)), this.cache.put_buffer(s), this.cache.put_buffer(d);
			}
			this.cache.put_buffer(s);
		}
		if (d > 0 && t.refine) {
			let s = [], u = [];
			for (let e = 0; e < a; ++e) v.data[e] && (s.push(n[e]), u.push(r[e]));
			if (s.length > f) {
				let _ = this.cache.get_buffer(p * h << 3), y = new l(p, h, g, _.data);
				if (o.copy_to(y), t.refine(s, u, o, s.length, d) > 0) {
					let s = this.cache.get_buffer(a << 2), u = this.cache.get_buffer(a), d = s.f32, p = new l(a, 1, i.U8C1_t, u.data), h = e.thresh;
					if (c === "lmeds") {
						t.error(n, r, o, d, a);
						let e = new m().median(d, 0, a - 1);
						h = Math.max(2.5 * 1.4826 * (1 + 5 / (a - f)) * Math.sqrt(e), .001);
					}
					this.find_inliers(t, o, n, r, a, h, d, p.data) >= f ? p.copy_to(v) : y.copy_to(o), this.cache.put_buffer(s), this.cache.put_buffer(u);
				}
				this.cache.put_buffer(_);
			}
		}
		return s && v.copy_to(s), this.cache.put_buffer(_), !0;
	}
}, G = class extends c {
	constructor() {
		super(), this.T0 = new l(3, 3, i.F64_t | i.C1_t), this.T1 = new l(3, 3, i.F64_t | i.C1_t), this.AtA = new l(6, 6, i.F32_t | i.C1_t), this.AtB = new l(6, 1, i.F32_t | i.C1_t);
	}
	sqr(e) {
		return e * e;
	}
	...
	have_collinear_points(e, t) {
		let n = 0, r = 0, a = t - 1 | 0, o = 0, s = 0, c = 0, l = 0;
	...
	run(e, t, n, r) {
		let a = 0, o = 0, s = n.type | i.C1_t, c = n.data, u = this.T0.data, d = this.T1.data, f, p, m = 0, h = 0, g = new y(), _ = new b();
		this.iso_normalize_points(e, t, u, d, r);
		let v = this.cache.get_buffer(2 * r * 6 << 3), x = this.cache.get_buffer(2 * r << 3), S = new l(6, 2 * r, s, v.data), C = new l(1, 2 * r, s, x.data), w = S.data, T = C.data;
		...
		return g.multiply_AtA(this.AtA, S), g.multiply_AtB(this.AtB, S, C), _.lu_solve(this.AtA, this.AtB), c[0] = this.AtB.data[0], c[1] = this.AtB.data[1], c[2] = this.AtB.data[2], c[3] = this.AtB.data[3], c[4] = this.AtB.data[4], c[5] = this.AtB.data[5], c[6] = 0, c[7] = 0, c[8] = 1, g.invert_3x3(this.T1, this.T1), g.multiply_3x3(n, this.T1, n), g.multiply_3x3(n, n, this.T0), this.cache.put_buffer(v), this.cache.put_buffer(x), 1;
	}
	error(e, t, n, r, i) {
	...
	refine(e, t, n, r, a = 10) {
		let o = this.cache.get_buffer(48), s = new l(1, 6, i.F64_t | i.C1_t, o.data);
		for (let e = 0; e < 6; ++e) s.data[e] = n.data[e];
		new b().lm_solve(s, r * 2, { compute: (n, i, a) => {
			for (let o = 0; o < r; ++o) {
				let r = e[o], s = t[o], c = n[0] * r.x + n[1] * r.y + n[2], l = n[3] * r.x + n[4] * r.y + n[5];
				if (i[2 * o] = c - s.x, i[2 * o + 1] = l - s.y, a) {
					let e = 2 * o * 6, t = (2 * o + 1) * 6;
					a[e + 0] = r.x, a[e + 1] = r.y, a[e + 2] = 1, a[e + 3] = 0, a[e + 4] = 0, a[e + 5] = 0, a[t + 0] = 0, a[t + 1] = 0, a[t + 2] = 0, a[t + 3] = r.x, a[t + 4] = r.y, a[t + 5] = 1;
				}
			}
			return !0;
		} }, a);
		for (let e = 0; e < 6; ++e) n.data[e] = s.data[e];
		return n.data[6] = 0, n.data[7] = 0, n.data[8] = 1, this.cache.put_buffer(o), 1;
	}
}, ne = class extends G {
	constructor() {
		super(), this.mLtL = new l(9, 9, i.F64_t | i.C1_t), this.Evec = new l(9, 9, i.F64_t | i.C1_t), this.model64 = new l(3, 3, i.F64_t | i.C1_t);
	}
	run(e, t, n, r) {
		let a = 0, o = 0, s = this.model64.data, c = this.T0.data, l = this.T1.data, u = this.mLtL.data, d = this.Evec.data, f = 0, p = 0, m = 0, h = 0, g = new b(), _ = new y(), v = 0, x = 0, S = 0, C = 0, w = 0, T = 0, E = 0, D = 0;
		for (; a < r; ++a) S += t[a].x, C += t[a].y, E += e[a].x, D += e[a].y;
		for (S /= r, C /= r, E /= r, D /= r, a = 0; a < r; ++a) v += Math.abs(t[a].x - S), x += Math.abs(t[a].y - C), w += Math.abs(e[a].x - E), T += Math.abs(e[a].y - D);
		if (Math.abs(v) < i.EPSILON || Math.abs(x) < i.EPSILON || Math.abs(w) < i.EPSILON || Math.abs(T) < i.EPSILON) return 0;
		for (v = r / v, x = r / x, w = r / w, T = r / T, c[0] = w, c[1] = 0, c[2] = -E * w, c[3] = 0, c[4] = T, c[5] = -D * T, c[6] = 0, c[7] = 0, c[8] = 1, l[0] = 1 / v, l[1] = 0, l[2] = S, l[3] = 0, l[4] = 1 / x, l[5] = C, l[6] = 0, l[7] = 0, l[8] = 1, a = 81; --a >= 0;) u[a] = 0;
		for (a = 0; a < r; ++a) f = (t[a].x - S) * v, p = (t[a].y - C) * x, m = (e[a].x - E) * w, h = (e[a].y - D) * T, u[0] += m * m, u[1] += m * h, u[2] += m, u[6] += m * -f * m, u[7] += m * -f * h, u[8] += m * -f, u[10] += h * h, u[11] += h, u[15] += h * -f * m, u[16] += h * -f * h, u[17] += h * -f, u[20] += 1, u[24] += -f * m, u[25] += -f * h, u[26] += -f, u[30] += m * m, u[31] += m * h, u[32] += m, u[33] += m * -p * m, u[34] += m * -p * h, u[35] += m * -p, u[40] += h * h, u[41] += h, u[42] += h * -p * m, u[43] += h * -p * h, u[44] += h * -p, u[50] += 1, u[51] += -p * m, u[52] += -p * h, u[53] += -p, u[60] += -f * m * -f * m + -p * m * -p * m, u[61] += -f * m * -f * h + -p * m * -p * h, u[62] += -f * m * -f + -p * m * -p, u[70] += -f * h * -f * h + -p * h * -p * h, u[71] += -f * h * -f + -p * h * -p, u[80] += -f * -f + -p * -p;
		for (a = 0; a < 9; ++a) for (o = 0; o < a; ++o) u[a * 9 + o] = u[o * 9 + a];
		return g.eigenVV(this.mLtL, this.Evec), s[0] = d[72], s[1] = d[73], s[2] = d[74], s[3] = d[75], s[4] = d[76], s[5] = d[77], s[6] = d[78], s[7] = d[79], s[8] = d[80], _.multiply_3x3(this.model64, this.T1, this.model64), _.multiply_3x3(this.model64, this.model64, this.T0), Math.abs(s[8]) <= i.EPSILON ? 0 : (f = 1 / s[8], s[0] *= f, s[1] *= f, s[2] *= f, s[3] *= f, s[4] *= f, s[5] *= f, s[6] *= f, s[7] *= f, s[8] = 1, this.model64.copy_to(n), 1);
	}
	error(e, t, n, r, i) {
	...
	refine(e, t, n, r, a = 10) {
		let o = this.cache.get_buffer(72), s = new l(1, 9, i.F64_t | i.C1_t, o.data);
		for (let e = 0; e < 9; ++e) s.data[e] = n.data[e];
		let c = Number.EPSILON;
		new b().lm_solve(s, r * 2, { compute: (n, i, a) => {
			for (let o = 0; o < r; ++o) {
				let r = e[o].x, s = e[o].y, l = n[6] * r + n[7] * s + n[8], u = Math.abs(l) > c ? 1 / l : 0, d = (n[0] * r + n[1] * s + n[2]) * u, f = (n[3] * r + n[4] * s + n[5]) * u;
				if (i[2 * o] = d - t[o].x, i[2 * o + 1] = f - t[o].y, a) {
					let e = 2 * o * 9, t = (2 * o + 1) * 9;
					a[e + 0] = r * u, a[e + 1] = s * u, a[e + 2] = u, a[e + 3] = 0, a[e + 4] = 0, a[e + 5] = 0, a[e + 6] = -d * u * r, a[e + 7] = -d * u * s, a[e + 8] = -d * u, a[t + 0] = 0, a[t + 1] = 0, a[t + 2] = 0, a[t + 3] = r * u, a[t + 4] = s * u, a[t + 5] = u, a[t + 6] = -f * u * r, a[t + 7] = -f * u * s, a[t + 8] = -f * u;
				}
			}
			return !0;
		} }, a);
		let u = s.data[8];
		if (Math.abs(u) <= i.EPSILON) return this.cache.put_buffer(o), 0;
		let d = 1 / u;
		for (let e = 0; e < 8; ++e) n.data[e] = s.data[e] * d;
		return n.data[8] = 1, this.cache.put_buffer(o), 1;
	}
}, K = class extends c {
	constructor() {
		super();
	...
	track(e, t, n, r, a, o, s, c, u, d) {
		...
		for (X = Ce; X >= 0; --X) for (I = 1 / (1 << X), x = y >> X, S = b >> X, A = x << 1, _ = h[X].data, v = g[X].data, re = x - o | 0, ie = S - o | 0, this.scharr_deriv(h[X], E), Z = 0; Z < a; ++Z) {
			if (K = Z << 1, q = K + 1, L = n[K] * I, R = n[q] * I, X == Ce ? (z = L, B = R) : (z = r[K] * 2, B = r[q] * 2), r[K] = z, r[q] = B, L -= f, R -= f, W = L | 0, G = R | 0, J = W <= 0 || W >= re || G <= 0 || G >= ie, J != 0) {
				X == 0 && (c[Z] = 0);
				continue;
			}
			...
			for (xe = 1 / xe, z -= f, B -= f, V = 0, ee = 0, Q = 0; Q < s; ++Q) {
				if (te = z | 0, ne = B | 0, J = te <= 0 || te >= re || ne <= 0 || ne >= ie, J != 0) {
					X == 0 && (c[Z] = 0);
					break;
				}
				for (ae = z - te, oe = B - ne, fe = (1 - ae) * (1 - oe) * le + .5 | 0, pe = ae * (1 - oe) * le + .5 | 0, me = (1 - ae) * oe * le + .5 | 0, he = le - fe - pe - me, se = 0, ce = 0, Y = 0; Y < o; ++Y) for (F = (Y + ne) * x + te | 0, N = Y * o | 0, P = N << 1, J = 0; J < o; ++J, ++F, ++N) ge = v[F] * fe + v[F + 1] * pe + v[F + x] * me + v[F + x + 1] * he, ge = ge + 256 >> 9, ge -= D[N], se += ge * O[P++], ce += ge * O[P++];
				if (se *= de, ce *= de, H = (ye * ce - be * se) * xe, U = (ye * se - ve * ce) * xe, z += H, B += U, r[K] = z + f, r[q] = B + f, H * H + U * U <= u) break;
	...
	ratio_test(e, t = .75) {
		...
		for (let r = 0; r < e.length; ++r) {
			let i = e[r];
			i.length >= 2 ? i[0].distance < t * i[1].distance && n.push(i[0]) : i.length === 1 && n.push(i[0]);
		}
		return n;
	}
}, Y = class {
	constructor() {
		this.R = new l(3, 3, i.F64_t | i.C1_t), this.t = /* @__PURE__ */ new Float64Array(3), this.good = !1;
	}
}, X = class e {
	constructor(t) {
	...
	static intrinsics(e, t, n = 60) {
		let r = new l(3, 3, i.F64_t | i.C1_t), a = .5 * e / Math.tan(.5 * n * Math.PI / 180), o = r.data;
		return o[0] = a, o[1] = 0, o[2] = .5 * e, o[3] = 0, o[4] = a, o[5] = .5 * t, o[6] = 0, o[7] = 0, o[8] = 1, r;
	}
	static invertIntrinsics(e) {
		let t = e.data, n = t[0], r = t[2], i = t[4], a = t[5];
	...
	estimate(t, n) {
		...
		let s = [
			...
			o[5],
			o[8]
		], u = Math.hypot(s[0], s[1], s[2]), d = Math.hypot(c[0], c[1], c[2]);
		if (u < 1e-12 || d < 1e-12) return r.good = !1, r;
		let f = 2 / (u + d), p = l[2] >= 0 ? 1 : -1, m = [
			p * s[0] / u,
			p * s[1] / u,
			p * s[2] / u
		], h = [
			...
			m[1] + h[1],
			m[2] + h[2]
		]), v = e.cross(m, h), y = e.normalize(e.cross(_, v)), b = Math.SQRT1_2, x = [
			(_[0] + y[0]) * b,
			(_[1] + y[1]) * b,
			(_[2] + y[2]) * b
		], S = [
			...
			(_[1] - y[1]) * b,
			(_[2] - y[2]) * b
		], C = e.cross(x, S), w = r.R.data;
		return w[0] = x[0], w[1] = S[0], w[2] = C[0], w[3] = x[1], w[4] = S[1], w[5] = C[1], w[6] = x[2], w[7] = S[2], w[8] = C[2], r.t[0] = g[0], r.t[1] = g[1], r.t[2] = g[2], r.good = !0, r;
	}
	static cross(e, t) {
		return [
			e[1] * t[2] - e[2] * t[1],
